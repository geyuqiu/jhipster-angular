...
public class StudentResourceIT {
    ...
    public static Student createEntity(EntityManager em) {
        ...
        if (TestUtil.findAll(em, University.class).isEmpty()) {
            university = UniversityResourceIT.createEntity(em);
            em.persist(university);
            em.flush();
        } else {
            university = TestUtil.findAll(em, University.class).get(0);
        }
    ...
    public static Student createUpdatedEntity(EntityManager em) {
        ...
        University university;
        if (TestUtil.findAll(em, University.class).isEmpty()) {
            university = UniversityResourceIT.createUpdatedEntity(em);
            em.persist(university);
            em.flush();
        } else {
            university = TestUtil.findAll(em, University.class).get(0);
