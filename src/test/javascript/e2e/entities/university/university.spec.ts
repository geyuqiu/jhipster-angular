...
describe('University e2e test', () => {
  ...
  describe('Create flow', () => {
    it('should load create University page', async () => {
      ...
      expect(await updatePage.title.getText()).to.match(/Create or edit a University/);
    });
    ...
    describe('Details, Update, Delete flow', () => {
      after(async () => {
        ...
        expect(await deleteDialog.title.getAttribute('id')).to.match(/lfiErfassungBackendApp.university.delete.question/);
