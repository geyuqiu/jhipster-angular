...
export default class StudentComponentsPage extends AlertPage {
...
export class StudentDeleteDialog {
  ...
  title: ElementFinder = element(by.id('lfiErfassungBackendApp.student.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-student'));
}
