...
@RestController
@RequestMapping("/api/lfi-erfassung-backend-kafka")
public class LfiErfassungBackendKafkaResource {

    private final Logger log = LoggerFactory.getLogger(LfiErfassungBackendKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public LfiErfassungBackendKafkaResource(KafkaProperties kafkaProperties) {
